...
int main() {
    ...
    LOG(INFO) << "Realme Power HAL AIDL Service with Extension is starting with config: "
              << config_path;
    ...
    LOG(INFO) << "Realme Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Realme Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
